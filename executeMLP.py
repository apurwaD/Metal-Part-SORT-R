...
"""
This method is used to plots the 
classification region for each point
"""
def plotRegion():
	x=0.0
...
'''
This method is used to classify each 
pixel and put it into the list for plotting
'''
...
'''
This method is used to classify each point 
of the csv and put it into the list for plotting
'''
